...
import { MapPin, Search, Eye, Edit, Trash2, Plus, Save, X, MinusCircle } from 'lucide-react';
...
const SalesmanRouteMapping = () => {
  ...
  const handleSave = () => {
    console.log('Saving salesman route mapping:', formData);
    ...
    <div className="p-3 sm:p-6 bg-gray-50 min-h-screen overflow-x-hidden">
      ...
      <div className="bg-purple-600 text-white px-3 sm:px-6 py-4 rounded-t-lg flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
        <div className="flex items-center gap-2 flex-wrap">
          ...
          <span className="text-sm sm:text-lg font-semibold">Salesman Route Mapping</span>
        </div>
        {view === 'list' && (
          <button
        ...
        {view === 'list' ? (
          ...
          <div className="p-3 sm:p-6 overflow-x-hidden">
            <div className="max-w-4xl mx-auto">
              <h3 className="text-lg font-semibold text-gray-800 mb-6">Salesman Route Mapping</h3>
              ...
              <div className="mb-6 border border-gray-300 rounded-lg p-4">
                <h4 className="text-lg font-semibold text-gray-800 mb-4">Attach Routes *</h4>
