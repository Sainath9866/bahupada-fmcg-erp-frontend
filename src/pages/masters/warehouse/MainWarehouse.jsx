...
import { Plus, Search, Filter, Edit, Trash2, Eye, Warehouse, MapPin, Phone, Users, Package } from 'lucide-react';
...
const MainWarehouse = () => {
  ...
  const filteredWarehouses = warehouses.filter(warehouse => {
    ...
    const matchesFilter = !filterStatus || warehouse.status === filterStatus;
  ...
  return (
    <div className="p-6">
      <div className="flex justify-between items-center mb-6">
        <h1 className="text-2xl font-bold text-gray-900">Main Warehouses</h1>
        <button
          ...
          <table className="w-full">
            ...
            <tbody className="bg-white divide-y divide-gray-200">
              {loading ? (
                ...
                <tr>
                  <td colSpan="6" className="px-6 py-4 text-center text-gray-500">No warehouses found</td>
                </tr>
              ) : (
