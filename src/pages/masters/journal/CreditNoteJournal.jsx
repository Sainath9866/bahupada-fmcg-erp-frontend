...
export default function CreditNoteJournal() {
  ...
  const fetchJournals = async () => {
    setLoading(true);
    try {
      const response = await api.get('/journals?type=Credit Note');
  ...
  return (
    <div className="p-6">
      <div className="flex justify-between items-center mb-6">
        <div>
          <h1 className="text-2xl font-semibold text-gray-800">Credit Note Journal</h1>
          <p className="text-gray-600">Manage credit note journal entries</p>
        </div>
        <button
              ...
              {loading ? (
                ...
                filteredJournals.map((journal) => (
                  <tr key={journal.id} className="hover:bg-gray-50">
                    ...
                    <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-900">
                      {customers.find(c => c.id === journal.customer)?.name || journal.customer || '-'}
                    </td>
                    <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-900">
          ...
          <div className="bg-white rounded-lg p-6 w-full max-w-2xl max-h-[80vh] overflow-y-auto">
            <div className="flex justify-between items-center mb-4">
              <h2 className="text-xl font-semibold text-gray-800">
                {editingJournal ? 'Edit Credit Note' : 'Add Credit Note'}
              </h2>
              <button
                onClick={() => {
                  setShowModal(false);
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <div className="flex justify-end gap-3 pt-4">
                ...
                >
                  {editingJournal ? 'Update' : 'Create'} Credit Note
                </button>
              </div>
            </form>
          </div>
