  ...
  const loadTrialBalance = async () => {
    ...
    try {
      const mockTrialBalance = [
        { id: 1, account_name: 'Cash Account', debit_balance: 50000, credit_balance: 0, type: 'Asset' },
        { id: 2, account_name: 'Bank Account', debit_balance: 250000, credit_balance: 0, type: 'Asset' },
        { id: 3, account_name: 'Sales Account', debit_balance: 0, credit_balance: 150000, type: 'Income' },
        { id: 4, account_name: 'Purchase Account', debit_balance: 80000, credit_balance: 0, type: 'Expense' },
        { id: 5, account_name: 'Accounts Payable', debit_balance: 0, credit_balance: 45000, type: 'Liability' }
      ];
  ...
  return (
    <div className="p-6 bg-gray-50 min-h-screen">
      <div className="mb-6">
        ...
        <p className="text-gray-600 mt-1">Financial trial balance report from Zoho Books</p>
      </div>
        ...
        <div className="overflow-x-auto">
          <table className="w-full">
            ...
            <tbody className="bg-white divide-y divide-gray-200">
              {loading ? (
                <tr>
                  <td colSpan="4" className="px-6 py-8 text-center text-gray-500">Loading trial balance...</td>
                </tr>
              ) : filteredTrialBalance.length === 0 ? (
                <tr>
                  <td colSpan="4" className="px-6 py-8 text-center text-gray-500">No accounts found</td>
                </tr>
              ) : (
            ...
            <tfoot className="bg-gray-50 border-t border-gray-200">
              <tr>
                ...
                <td className="px-6 py-3 text-right text-sm font-bold text-gray-900">₹{totalDebit.toLocaleString()}</td>
                <td className="px-6 py-3 text-right text-sm font-bold text-gray-900">₹{totalCredit.toLocaleString()}</td>
              </tr>
            </tfoot>
          </table>
        </div>
