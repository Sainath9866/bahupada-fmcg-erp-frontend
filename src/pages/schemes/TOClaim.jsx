  ...
  const sampleClaims = [
    {
      id: 1,
      claimCode: 'TOC001',
      claimDescription: 'TO Volume Bonus',
      claimDate: '15/01/2024',
      claimYear: '2024',
      claimMonth: 'January',
      claimAmount: '₹40,000',
      remarks: 'TO Q1 Achievement',
      status: 'Approved'
    },
    {
      id: 2,
      claimCode: 'TOC002',
      claimDescription: 'TO Target Incentive',
      claimDate: '20/01/2024',
      claimYear: '2024',
      claimMonth: 'January',
      claimAmount: '₹30,000',
      remarks: 'Monthly TO Target',
      status: 'Pending'
    },
    {
      id: 3,
      claimCode: 'TOC003',
      claimDescription: 'TO Special Claim',
      claimDate: '25/01/2024',
      claimYear: '2024',
      claimMonth: 'January',
      claimAmount: '₹45,000',
      remarks: 'TO Festival Promotion',
      status: 'Rejected'
    }
  ];
    ...
    <div className="bg-gray-50 min-h-screen" style={{ padding: window.innerWidth < 640 ? '4px' : '24px', maxWidth: window.innerWidth < 640 ? '100vw' : '100%', width: window.innerWidth < 640 ? '100vw' : 'auto', overflowX: 'hidden', margin: 0, boxSizing: 'border-box' }}>
      ...
      <div className="bg-purple-600 text-white px-1 sm:px-6 py-1 sm:py-4 rounded-t-lg flex flex-col sm:flex-row items-start sm:items-center justify-between gap-1 sm:gap-4">
        <div className="flex items-center gap-1 sm:gap-2" style={{ fontSize: window.innerWidth < 640 ? '11px' : '16px' }}>
          ...
          <span className="font-semibold">{window.innerWidth < 640 ? 'TO Claim' : 'TO Claim'}</span>
        </div>
      </div>
