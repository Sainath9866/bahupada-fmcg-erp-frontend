  ...
  const sampleClaims = [
    {
      id: 1,
      claimCode: 'ITC001',
      claimDescription: 'Invoice Total Bonus',
      claimDate: '12/01/2024',
      claimYear: '2024',
      claimMonth: 'January',
      claimAmount: '₹60,000',
      remarks: 'Monthly Invoice Target',
      status: 'Approved'
    },
    {
      id: 2,
      claimCode: 'ITC002',
      claimDescription: 'Invoice Volume Incentive',
      claimDate: '18/01/2024',
      claimYear: '2024',
      claimMonth: 'January',
      claimAmount: '₹40,000',
      remarks: 'Volume Achievement Bonus',
      status: 'Pending'
    },
    {
      id: 3,
      claimCode: 'ITC003',
      claimDescription: 'Invoice Value Claim',
      claimDate: '22/01/2024',
      claimYear: '2024',
      claimMonth: 'January',
      claimAmount: '₹75,000',
      remarks: 'High Value Invoice Bonus',
      status: 'Approved'
    }
  ];
    ...
    <div className="bg-gray-50 min-h-screen" style={{ padding: window.innerWidth < 640 ? '4px' : '24px', maxWidth: window.innerWidth < 640 ? '100vw' : '100%', width: window.innerWidth < 640 ? '100vw' : 'auto', overflowX: 'hidden', margin: 0, boxSizing: 'border-box' }}>
      ...
      <div className="bg-purple-600 text-white px-1 sm:px-6 py-1 sm:py-4 rounded-t-lg flex flex-col sm:flex-row items-start sm:items-center justify-between gap-1 sm:gap-4">
        <div className="flex items-center gap-1 sm:gap-2" style={{ fontSize: window.innerWidth < 640 ? '11px' : '16px' }}>
          ...
          <span className="font-semibold">{window.innerWidth < 640 ? 'Invoice Tot Claim' : 'Invoice Tot Claim'}</span>
        </div>
      </div>
        ...
        <div style={{ padding: window.innerWidth < 640 ? '8px' : '24px', margin: 0, boxSizing: 'border-box' }}>
          <div className="max-w-4xl mx-auto">
            ...
            <div className="text-sm text-gray-600 mb-6">
              Home › Schemes & Claims › Invoice Tot Claim
            </div>
...
export default InvoiceTotClaim;
